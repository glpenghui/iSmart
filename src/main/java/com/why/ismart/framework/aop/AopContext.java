...
public class AopContext {
    ...
    static{
        ...
        Map<Class<?>, List<Proxy>> beanClass2ProxyListMap = parseBeanClass2ProxyListMap();
    ...
    public static Map<Class<?>, List<Proxy>> parseBeanClass2ProxyListMap(){
        Map<Class<?>, List<Proxy>> result = new HashMap<Class<?>, List<Proxy>>();
        Map<Class<?>, Set<Class<?>>> aspectProxy2BeanClassesMap = getAspectProxy2BeanClassesMap();
        for(Map.Entry<Class<?>, Set<Class<?>>> entry:aspectProxy2BeanClassesMap.entrySet()){
